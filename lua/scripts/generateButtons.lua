...
local widgetHeight = 27
local widgetWidth = 640
...
local widgetButton = {
    ...
    event_handlers = {
        {
            ...
            script = "set_dynamic_menu_trigger_{buttonIndex}"
        },
        {
    ...
    background_bitmap = [[ui\shell\bitmaps\loc_menu_bkds_sm.bitmap]],
    text_label_unicode_strings_list = [[ui\conversation\strings\dynamic_strings.unicode_string_list]],-- TODO Create and strings here,
    text_font = [[ui\small_ui.font]],
    text_color = "1 1 1 1",
