...
local paths = {
    meters = "ui\\hud\\bitmaps\\combined\\meters_hrhh",
    metersAlphas = "ui\\hud\\bitmaps\\combined\\alphas_hrhh",
    --weaponIcons = "ui\\hud\\bitmaps\\combined\\hud_weapon_icons_final",
    numbers = "ui\\hud\\bitmaps\\combined\\hud_counter_numbers_hrhh",
    --percentageSign = "ui\\hud\\bitmaps\\combined\\plasma percentage" 
}
